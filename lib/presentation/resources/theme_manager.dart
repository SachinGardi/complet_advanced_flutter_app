  ...
  return ThemeData(
      ...
      textTheme: TextTheme(
          displayLarge: getSemiBoldStyle(
              color: ColorManager.darkGrey, fontSize: FontSize.s16),///for headline1 deprecated
          ...
          titleMedium: getMediumStyle(
              color: ColorManager.lightGrey, fontSize: FontSize.s14), /// for subtitle1 deprecated
          titleSmall:getMediumStyle(
              color: ColorManager.primary, fontSize: FontSize.s14),///for subtitle2 deprecated
